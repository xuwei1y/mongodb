...
handle_call( { set_database , Database } , _From , State = #state{conn_state = Conn_state} ) ->
  NewConn_state = Conn_state#conn_state{database = Database } ,
  {reply, ok , State#state{conn_state = NewConn_state} };

...
%% @doc Set one worker database
set_database( Worker , Database ) when is_binary(Database ) ->
  gen_server:call(Worker, { set_database , Database }).
